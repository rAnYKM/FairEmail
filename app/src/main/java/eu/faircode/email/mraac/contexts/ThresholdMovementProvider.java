...
public class ThresholdMovementProvider extends BaseContextProvider {
    public ThresholdMovementProvider(String id, Context context) {
        super(id, context);
    }
    ...
    public void start(Adaptation adaptation) {
        ...
        Intent i = new Intent(getContext(), ThresholdMovementService.class);
